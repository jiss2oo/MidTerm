...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        bool horizontal = !Mathf.Approximately(movement.x, 0f);
        bool vertical = !Mathf.AreApproximately(movement.y, 0f);
